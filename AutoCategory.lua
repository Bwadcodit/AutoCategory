...
function AutoCategory.RefreshAllLists()
    PLAYER_INVENTORY:UpdateList(INVENTORY_BACKPACK, UPDATE_IF_NOT_HIDDEN)
    PLAYER_INVENTORY:UpdateList(INVENTORY_QUEST_ITEM, UPDATE_IF_NOT_HIDDEN)
    PLAYER_INVENTORY:UpdateList(INVENTORY_CRAFT_BAG, UPDATE_IF_NOT_HIDDEN)
    PLAYER_INVENTORY:UpdateList(INVENTORY_GUILD_BANK, UPDATE_IF_NOT_HIDDEN)
    PLAYER_INVENTORY:UpdateList(INVENTORY_HOUSE_BANK, UPDATE_IF_NOT_HIDDEN)
    PLAYER_INVENTORY:UpdateList(INVENTORY_BANK, UPDATE_IF_NOT_HIDDEN)
